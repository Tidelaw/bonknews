    ...
    return (
        tweets[0] ?
            <div className='w-full h-full'>
                ...
                <ResponsiveContainer width="99%" height={350} className='flex bg-neutral-900'>
                    <ScatterChart
                        data={ScatterData}
                    >
            ...
            <div className='flex justify-center w-full rounded-lg shadow shadow-none bg-neutral-900 flex-col p-4 items-center'>
