    ...
    return (
        data[0] ?
            <div className='w-full h-full space-y-4'>
                ...
                <div className='flex p-2 w-full justify-between flex-row items-center'>
            ...
            <div className='flex justify-center w-full h-[350px] rounded-lg shadow shadow-none bg-neutral-900 flex-col xl:p-4 items-center'>
